...
class Browser(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        back = wx.BitmapButton(toolbar1, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        forward = wx.BitmapButton(toolbar1, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        refresh = wx.BitmapButton(toolbar1, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        stop = wx.BitmapButton(toolbar1, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        home = wx.BitmapButton(toolbar1, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        address = wx.ComboBox(toolbar1, -1, size=(50, -1))
        go = wx.BitmapButton(toolbar1, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        ...
        bookmark1 = wx.BitmapButton(toolbar2, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        bookmark2 = wx.BitmapButton(toolbar2, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
        bookmark3 = wx.BitmapButton(toolbar2, -1, wx.Bitmap('file.png'),
                style=wx.NO_BORDER)
